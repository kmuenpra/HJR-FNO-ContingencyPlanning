...
# result_4D = HJSolver(sys4D, g, Initial_value_f, tau, compMethod, saveAllTimeSteps=False)
...
# # STEP 5: Call HJSolver function
# compMethod = { "TargetSetMode": "None"}
# result_3D = HJSolver(sys, g, Initial_value_f, tau, compMethod, saveAllTimeSteps=False)
...
# STEP 4: System dynamics for computati
sys = Plane2D()
...
# result_1D = HJSolver(sys_1, g_1, Initial_value_f_1, tau, compMethod, saveAllTimeSteps=False)
